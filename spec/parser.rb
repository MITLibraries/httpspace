...
RSpec.describe Parser do
  it "finds all the http://ocw.mit.edu links in xml" do
    @parser = Parser.new
    testfile = File.join(File.dirname(__FILE__), '../files/75804/imsmanifest.xml')
  ...
  it "finds all the http://ocw.mit.edu links in html" do
    @parser = Parser.new
    testfile = File.join(File.dirname(__FILE__), '../files/75804/5-301-january-iap-2004/contents/index.htm')
    @parser.update([testfile])
